...
export function Captacion() {
  const { contactos, captaciones, contactoNombre, crearCaptacion, toggleChecklistCaptacion, cambiarEstadoCaptacion, abrirExpediente, guardarACM } = useAppData();
  ...
  return (
    <div>
      ...
      <DetalleCaptacionModal
        ...
        onAbrirContacto={abrirExpediente} onGuardarACM={guardarACM}
      />
    </div>
  );
}
